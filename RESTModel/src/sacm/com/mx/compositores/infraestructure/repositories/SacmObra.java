...
public class SacmObra implements Serializable {
 ...
 public static ObraResultDto sacmConsultaObra(PalabraIdObra palabra) {
        CallableStatement cstmt = null;
        ResultSet rs = null;
        Connection conn = null;
        ...
        try {
            ...
            // 3. Set the bind values of the IN parameters
            cstmt.setObject(1, palabra.getBusqueda().getPalabra());
            ...
            while (rs.next()) {
                ...
                obra.setObra_numero(rs.getInt(2));
                obra.setObra_id_album(rs.getInt(3));
                obra.set_Imagen(rs.getObject(4) == null ? null : rs.getString(4));
                obra.setObra_titulo(rs.getString(5));
                obra.setObra_descripcion(rs.getString(6));
                obra.setVersion_duracion(rs.getString(7));
                obra.setVersion_wav(rs.getObject(8) == null ? null : rs.getString(8));
                obra.setVersion_mp3(rs.getObject(9) == null ? null : rs.getString(9));
                obra.setVersion_aiff(rs.getObject(10) == null ? null : rs.getString(10));
    ...
    public static ObraResultDto compartirObra(CompObraResultDto obraRequest) {
         CallableStatement cstmt = null;
         Connection conn = null;
         ObraDto obra= new ObraDto();
         ...
         try {
            ...
            cstmt = conn.prepareCall("{call SACM_PRC_COMPARTIR_OBRA(?,?,?,?,?,?,?)}");
             ...
             // 3. Set the bind values of the IN parameters
             cstmt.setObject(1,12);// obraRequest.getObra().getIdObra());
             cstmt.setObject(2,21);// obraRequest.getObra().getIdObra());
             cstmt.setObject(3,1);// obraRequest.getObra().getIdObra());
    ...
    public static ObraResultDto getMp3Obra(ObraDto obraRequest) {
        CallableStatement cstmt = null;
        ResultSet rs = null;
        Connection conn = null;
